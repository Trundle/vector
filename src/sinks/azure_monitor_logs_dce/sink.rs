...
use crate::{
    ...
    sinks::util::{
        ...
        BatchConfig, Compression, RealtimeSizeBasedDefaultBatchSettings, RequestBuilder,
        SinkBuilderExt, TowerRequestConfig,
    },
    sinks::Healthcheck,
...
impl SinkConfig for AzureMonitorLogsDceConfig {
    async fn build(&self, cx: SinkContext) -> crate::Result<(VectorSink, Healthcheck)> {
        let creds = AzureAuthenticator::new().await?;
